    ...
    <div class="container">
        ...
        <div class="card card-dark">
            <div class="card-header">
                <h6 class="">روابط موضوع({{\App\Models\Trailer::find($trailer_id)->title}})</h6>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <button type="button" class="btn btn-success m-3" id="add">+</button>
            <form role="form" action="{{route('dashboard.trailerLinks.store')}}" method="post" enctype="multipart/form-data">
                @csrf
