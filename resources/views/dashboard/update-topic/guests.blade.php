    ...
    <div class="container">
        <div class="card card-dark mt-5">
            ...
            <div class="alert alert-warning" role="alert">
                ملاحظة سيتم حذف القديم من الشخصيات ان وجدت لكي تتم عملية التحديث.
            </div>

            <button type="button" class="btn btn-success m-3" id="add">+</button>


            <form role="form" action="{{route('dashboard.update.update.guests')}}" method="post" enctype="multipart/form-data">
                @csrf
