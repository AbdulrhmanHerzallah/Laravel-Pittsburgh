...
<div class="container">
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h6 class="">شركاء النجاح</h6>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form role="form" action="{{route('dashboard.success.store')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
...
{{--                <div class="form-group">--}}
{{--                    <label for="name">اسم المتج الصوتي</label>--}}
{{--                    <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name">--}}
{{--                </div>--}}

{{--                <div class="form-group">--}}
{{--                    <label for="twitter">موقع</label>--}}
{{--                    <input type="text" class="form-control @error('twitter') is-invalid @enderror" name="twitter" id="twitter" placeholder="">--}}
{{--                </div>--}}

                <div class="form-group">
                    <label for="desc">وصف الشريك</label>
                    <textarea class="form-control @error('desc') is-invalid @enderror" name="desc" id="desc" rows="3" required></textarea>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            ...
                            @error('img_url') <span class="text-danger">الحجم او النوع او انك لم ترفق صورة!</span> @enderror
    ...
    <table class="table table-dark">
        ...
        @foreach($success as $i)
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#update" data-id="{{$i->id}}" data-name="{{$i->name}}" data-desc="{{$i->desc}}" data-route="{{route('dashboard.success.update' , ['id' => $i->id])}}">
                        <i class="fas fa-edit"></i>
                    </button>
                </td>
                <td>
                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#delete" data-title="{{$i->name}}" data-route="{{route('dashboard.success.delete' , ['id' => $i->id])}}">
