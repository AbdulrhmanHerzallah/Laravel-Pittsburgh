...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="/logo/logo.png" alt="Pittsburgh" class="brand-image img-circle "
             style="">
        <span class="brand-text font-weight-light">Pittsburgh</span>
    </a>
...
{{--                            <span class="badge badge-info right">6</span>--}}
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('dashboard.content_page.create')}}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>{{__('dashboard_layout.content_page')}}</p>
                            </a>
                        </li>
                        <li class="nav-item">
